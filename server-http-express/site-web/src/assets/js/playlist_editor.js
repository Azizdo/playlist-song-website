...
import { HTTP_STATUS } from "../../../../server/utils/http.js";
...
export default class PlayListEditor {
  ...
  async deletePlaylist (id) {
    const deleteResponseStatus = await this.HTTPManager.deletePlaylist(id);
    if (deleteResponseStatus === HTTP_STATUS.SUCCESS) window.location.replace("http://localhost:5000/index.html");
  }
