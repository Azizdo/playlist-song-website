...
const search_barRouteur = require("./routes/search_bar");
const songsRouteur = require("./routes/songs")
...
app.use("/api/search", search_barRouteur.router);
app.use("/api/songs", songsRouteur.router);
